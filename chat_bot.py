...
from workflow.states.simple_state import SimpleState
...
async def on_message(msg: cl.Message):
    ...
    rag_workflow = load_rag_workflow_from_schema(WORKFLOW_SCHEMAS_FOLDER_PATH / "auchan_schema.yaml")
    ...
    async for output, metadata in rag_workflow.astream(
        ...
        if metadata.get("langgraph_node") == END:
            ...
            if final_answer_text:
                ...
                cl.user_session["message_history"].append(f"Assistant: {final_answer_text}")
